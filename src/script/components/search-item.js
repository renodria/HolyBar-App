...
class SearchItem extends HTMLElement {
  ...
  render() {
    this.innerHTML = `
    <section class="flex flex-col items-center justify-center gap-4 relative" id="searchFood">
        <h1 class="lg:text-3xl text-xl font-bold leading-relaxed" data-aos="fade-up" data-aos-duration="800" data-aos-once="true">Cari menu</h1>
        <form class="lg:w-[450px] md:w-[400px] w-[350px] relative" data-aos="fade-up" data-aos-duration="800" data-aos-once="true">
                ...
                <input id="searchElement" type="search" class="block drop-shadow-lg w-full p-4 pl-10 focus:outline-none border-b md:text-base text-sm " placeholder="Ketik Disini.." required/>
                
                <button type="submit" id="searchButtonElement" class="text-white bg-accent transition-all duration-300 absolute right-2.5 bottom-2.5 font-medium rounded-lg px-8 py-2 z-[99] md:text-base text-sm">
                  Cari
                </button>
